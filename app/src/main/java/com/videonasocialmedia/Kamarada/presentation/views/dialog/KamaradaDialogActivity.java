...
public class KamaradaDialogActivity extends DialogFragment {
    ...
    public KamaradaDialogActivity(){
        // Empty constructor required for DialogFragment
    }

    public static KamaradaDialogActivity newInstance(String title, String message, String accept,
                                                    String cancel, int idDialog) {
        KamaradaDialogActivity frag = new KamaradaDialogActivity();
